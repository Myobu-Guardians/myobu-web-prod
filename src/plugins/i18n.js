...
const messages = {
    ...
    'cn': {
        ...
        howToBuy: '如何购买',
        audit: '审计',
        welcomeMsg: '天狐精灵Myōbu有着白色的皮毛和丰满蓬松的尾巴，这些特征让人不禁联想到成熟的谷物，所以它被人们认为是带来祝福的神圣生物。',
        buyUniswap: '在 Uniswap 上购买',
        priceChart: '价格图表',
        tokenomics: '代币经济',
        trillion: '兆',
        totalSupply: '总供应量',
        redRateText: '24小时内的多次销售会被收 取递增的税，详情请继续浏览',
        fairLaunch: '公平发布',
        fairLaunchText: '没有预售，开发者不持有代币',
        safe: '安全',
        safeText: '资金池在Uniswap锁定， 还有管理权限丢弃。',
        devFee: '开发者团队收取费用',
        devFeeText: '购买时的6%,   第一次销售的5% ，第2-4次销售时的10%',
        antiDumpTitle: '$MYOBU 反倾销保护',
        antiDumpText1: 'Myōbu 的机制是奖励持币者反对倾销，从过去所谓的“反鲸鱼”代币的错误中吸取教训，这些代币具有固定的交易和钱包限制，随着代币数量的减少，这些代币变得毫无用处',
        antiDumpText2: '每次卖出的总价值会被限制在 2.9%价格影响率以内的，以防止大户倾销。在 24 小时内只允许 4 次销售，并增加销售冷却时间和连续销售的税率，以防止连续倾销。',
        howToBuyTitle: '如何购买 $MYOBU',
        step1Title: '拥有一个 MetaMask 钱包',
        step1Text: '$MYOBU token 是基于以太大陆上的代币. MetaMask是最好的erc20持币钱包之一.',
        step2Title: '发送$ETH 到MetaMask 钱包',
        step2Text: '您可以在MetaMask上购买ETH，或者从别的可信任的钱包发送到Metamask钱包上（例如 Coinbas 或者Binance）。',
        step3Title: '浏览Uniswap网页',
        step3Text: '最安全的方式是在Uniswap上购买。  浏览Uniswap，然后点击“连接钱包”，Metamask会需要你的授权，然后登陆您的帐号。',
        step4Title: '转换 $ETH 变成$Myobu',
        step4Text: '设定 滑点为10%，然后输入你想转换数量， 点击链接钱包后进行交易.',
        roadmap: '发展规划',
        phase1: '第一阶段',
        websiteLaunch: '官网运行',
