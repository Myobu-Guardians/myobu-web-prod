          ...
          <div class="col-md-8 offset-md-2 col-12 offset-sm-0">
            <div class="input-group">
              ...
              <div class="input-group-addon">
                <img src="img/bnb.png" width="40" height="40">
              </div>
            </div>
          </div>
          <div class="col-md-8 offset-md-2 col-12 offset-sm-0">
            Balance: {{ format(ethBalance, 2) }} BNB <a class="highlight underline" @click="updateEth">(MAX)</a>
          </div>
        </div>
        ...
        <div class="row align-items-center mt-3 justify-content-between">
          <div class="col-md-4 col-lg-4 offset-md-2 offset-lg-4 text-center">
            ...
            <div v-else-if="parseFloat(ethAmount) > parseFloat(ethBalance)">
              <button class="btn staking red" disabled="disabled">Insufficient BNB balance</button>
            </div>
            <div v-else>
...
export default {
  ...
  methods: {
    ...
    stake: async function () {
      ...
      let lockDuration = this.lockDuration.value * 604800 // 604800
    ...
    getDailyRewards: async function () {
      ...
      this.dr = 28800 * ethPerBlock * this.ethPrice * this.poolInfo.allocPoint / totalAllocPoint
    },
